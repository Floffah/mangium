...
import {post, settingGet} from "./lib/comms";
    ...
    if (typeof pages[reqpage] === "function") {
        ...
        if (renderPage.permission) {
            if (clientpermissions[renderPage.permission] === true || clientpermissions.override === "ALL" || clientpermissions.override === "all") {
                ReactDOM.render(<Body data={data} doSidebar={renderPage.sidebar}
                                      menukey={renderPage.key}>{renderPage.el}</Body>, document.getElementById("content"));
            } else {
